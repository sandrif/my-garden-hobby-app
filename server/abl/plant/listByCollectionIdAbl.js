...
async function ListByCollectionIdAbl(req, res) {
  try {
    const filter = req.query?.collectionId ? req.query : req.body;
    ...
    const plantList = plantDao.listByCollectionId(filter);
...
module.exports = ListByCollectionIdAbl;